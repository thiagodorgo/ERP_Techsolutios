...
// Ω5P PR-18a — Web Worker que RESOLVE o proof-of-work fora da thread da UI (transparente para a autoridade). Procura
// um inteiro `n` tal que SHA-256("salt:n") tenha `difficulty` NIBBLES hex zero à esquerda — o MESMO algoritmo que o
// BFF verifica em O(1). Usa crypto.subtle (SHA-256 NATIVO) → correto por construção, sem crypto reimplementada.
