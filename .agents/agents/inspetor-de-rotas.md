...
> **Papel para o Codex** — espelho de `.claude/agents/inspetor-de-rotas.md` (D-INTEROP-CLAUDE-CODEX). Adote as
> instruções abaixo como o seu system-prompt ao atuar como **inspetor-de-rotas** na junta (§C7 do `AGENTS.md`).
