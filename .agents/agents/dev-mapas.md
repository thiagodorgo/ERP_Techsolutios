...
> **Papel para o Codex** — espelho de `.claude/agents/dev-mapas.md` (D-INTEROP-CLAUDE-CODEX). Adote as
> instruções abaixo como o seu system-prompt ao atuar como **dev-mapas** na junta (§C7 do `AGENTS.md`).
