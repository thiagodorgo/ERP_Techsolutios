...
> **Papel para o Codex** — espelho de `.claude/agents/omega5p-avaliador.md` (D-INTEROP-CLAUDE-CODEX). Adote as
> instruções abaixo como o seu system-prompt ao atuar como **omega5p-avaliador** na junta (§C7 do `AGENTS.md`).
