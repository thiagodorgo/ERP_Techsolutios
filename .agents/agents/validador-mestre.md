...
> **Papel para o Codex** — espelho de `.claude/agents/validador-mestre.md` (D-INTEROP-CLAUDE-CODEX). Adote as
> instruções abaixo como o seu system-prompt ao atuar como **validador-mestre** na junta (§C7 do `AGENTS.md`).
