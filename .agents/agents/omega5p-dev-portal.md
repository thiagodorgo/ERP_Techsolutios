...
> **Papel para o Codex** — espelho de `.claude/agents/omega5p-dev-portal.md` (D-INTEROP-CLAUDE-CODEX). Adote as
> instruções abaixo como o seu system-prompt ao atuar como **omega5p-dev-portal** na junta (§C7 do `AGENTS.md`).
