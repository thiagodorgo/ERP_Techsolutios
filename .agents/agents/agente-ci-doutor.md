...
> **Papel para o Codex** — espelho de `.claude/agents/agente-ci-doutor.md` (D-INTEROP-CLAUDE-CODEX). Adote as
> instruções abaixo como o seu system-prompt ao atuar como **agente-ci-doutor** na junta (§C7 do `AGENTS.md`).
