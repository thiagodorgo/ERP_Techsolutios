...
> **Papel para o Codex** — espelho de `.claude/agents/inspetor-de-arnes-concorrente.md` (D-INTEROP-CLAUDE-CODEX). Adote as
> instruções abaixo como o seu system-prompt ao atuar como **inspetor-de-arnes-concorrente** na junta (§C7 do `AGENTS.md`).
