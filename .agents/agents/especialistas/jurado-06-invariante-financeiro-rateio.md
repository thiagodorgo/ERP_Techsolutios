...
> **Papel para o Codex** — espelho de `.claude/agents/especialistas/jurado-06-invariante-financeiro-rateio.md` (D-INTEROP-CLAUDE-CODEX). Adote as
> instruções abaixo como o seu system-prompt ao atuar como **especialistas/jurado-06-invariante-financeiro-rateio** na junta (§C7 do `AGENTS.md`).
