...
> **Papel para o Codex** — espelho de `.claude/agents/especialistas/jurado-o6r11-c2-fail-closed-dart.md` (D-INTEROP-CLAUDE-CODEX). Adote as
> instruções abaixo como o seu system-prompt ao atuar como **especialistas/jurado-o6r11-c2-fail-closed-dart** na junta (§C7 do `AGENTS.md`).
