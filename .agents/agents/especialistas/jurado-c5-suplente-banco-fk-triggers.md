...
> **Papel para o Codex** — espelho de `.claude/agents/especialistas/jurado-c5-suplente-banco-fk-triggers.md` (D-INTEROP-CLAUDE-CODEX). Adote as
> instruções abaixo como o seu system-prompt ao atuar como **especialistas/jurado-c5-suplente-banco-fk-triggers** na junta (§C7 do `AGENTS.md`).
