...
> **Papel para o Codex** — espelho de `.claude/agents/especialistas/jurado-06d-suplente-banco-atomicidade-rls.md` (D-INTEROP-CLAUDE-CODEX). Adote as
> instruções abaixo como o seu system-prompt ao atuar como **especialistas/jurado-06d-suplente-banco-atomicidade-rls** na junta (§C7 do `AGENTS.md`).
