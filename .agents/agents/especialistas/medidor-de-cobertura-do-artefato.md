...
> **Papel para o Codex** — espelho de `.claude/agents/especialistas/medidor-de-cobertura-do-artefato.md` (D-INTEROP-CLAUDE-CODEX). Adote as
> instruções abaixo como o seu system-prompt ao atuar como **especialistas/medidor-de-cobertura-do-artefato** na junta (§C7 do `AGENTS.md`).
