...
> **Papel para o Codex** — espelho de `.claude/agents/especialistas/jurado-arnes-runner-denominador.md` (D-INTEROP-CLAUDE-CODEX). Adote as
> instruções abaixo como o seu system-prompt ao atuar como **especialistas/jurado-arnes-runner-denominador** na junta (§C7 do `AGENTS.md`).
