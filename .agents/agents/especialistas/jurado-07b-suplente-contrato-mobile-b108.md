...
> **Papel para o Codex** — espelho de `.claude/agents/especialistas/jurado-07b-suplente-contrato-mobile-b108.md` (D-INTEROP-CLAUDE-CODEX). Adote as
> instruções abaixo como o seu system-prompt ao atuar como **especialistas/jurado-07b-suplente-contrato-mobile-b108** na junta (§C7 do `AGENTS.md`).
