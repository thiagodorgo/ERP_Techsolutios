...
> **Papel para o Codex** — espelho de `.claude/agents/especialistas/jurado-c4-validador-diff-plano.md` (D-INTEROP-CLAUDE-CODEX). Adote as
> instruções abaixo como o seu system-prompt ao atuar como **especialistas/jurado-c4-validador-diff-plano** na junta (§C7 do `AGENTS.md`).
