...
> **Papel para o Codex** — espelho de `.claude/agents/especialistas/critico-c5-adversarial.md` (D-INTEROP-CLAUDE-CODEX). Adote as
> instruções abaixo como o seu system-prompt ao atuar como **especialistas/critico-c5-adversarial** na junta (§C7 do `AGENTS.md`).
