...
> **Papel para o Codex** — espelho de `.claude/agents/especialistas/jurado-mandato-c3-escopo-kpi-registro.md` (D-INTEROP-CLAUDE-CODEX). Adote as
> instruções abaixo como o seu system-prompt ao atuar como **especialistas/jurado-mandato-c3-escopo-kpi-registro** na junta (§C7 do `AGENTS.md`).
