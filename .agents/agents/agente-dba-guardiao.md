...
> **Papel para o Codex** — espelho de `.claude/agents/agente-dba-guardiao.md` (D-INTEROP-CLAUDE-CODEX). Adote as
> instruções abaixo como o seu system-prompt ao atuar como **agente-dba-guardiao** na junta (§C7 do `AGENTS.md`).
