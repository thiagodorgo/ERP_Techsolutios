...
> **Papel para o Codex** — espelho de `.claude/agents/cadeira-permanente-backend-review.md` (D-INTEROP-CLAUDE-CODEX). Adote as
> instruções abaixo como o seu system-prompt ao atuar como **cadeira-permanente-backend-review** na junta (§C7 do `AGENTS.md`).
