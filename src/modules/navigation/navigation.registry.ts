...
export const NAVIGATION_REGISTRY: readonly NavigationItem[] = [
  ...
  // B-SAN3-04a (item 13, P-Ω4-FINANCE-READ-ORFA) — o grupo Financeiro era governado por permissões ÓRFÃS
  // (finance:read / billing:read / invoices:read / payments:read: nenhuma rota compara; só admins as têm), então
  // o menu real tirava Financeiro/Cobranças/Pagamentos do Financeiro e do Gestor. Gate ÚNICO pela permissão que
  // a rota E o App.tsx comparam: /finance → financial_entries:read (financial-summary); /finance/charges,
  // /finance/invoices, /finance/payments → financial_titles:read (financial-title.routes.ts). SEM permissão nova.
  {
    id: "finance.dashboard",
    label: "Financeiro",
    description: "Visão financeira da organização.",
    path: "/finance",
    icon: "ChartNoAxesCombined",
    group: "finance",
    order: 400,
    status: "implemented",
    requiredPermissions: ["financial_entries:read"],
  ...
  },
  {
    id: "finance.charges",
    label: "Cobranças",
    description: "Cobranças da organização.",
    path: "/finance/charges",
    icon: "ReceiptText",
    group: "finance",
    order: 410,
    status: "implemented",
    requiredPermissions: ["financial_titles:read"],
    requiredModules: ["finance"],
    tenantOnly: true,
  },
  {
  ...
  },
  {
    id: "finance.payments",
    label: "Pagamentos",
    description: "Pagamentos da organização.",
