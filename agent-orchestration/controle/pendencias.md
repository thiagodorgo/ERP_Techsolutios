...
- status: ABERTA (`B-GOV-MANDATO`, medição do **dev**, achada ao derrubar a 3ª hipótese do mandato — a hipótese era sobre falso **positivo** e não caiu; esta é a propriedade **vizinha**, o falso **negativo**, que a sonda encontrou de passagem)
