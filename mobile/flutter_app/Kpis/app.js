...
const EMBEDDED_LATEST = {
  ...
  "release": {
    ...
    "fallback": "OS continua local-first: a action local-only fica salva localmente e permanece pending ate haver mapeamento remoto; erro de rede vira failed retryable sem marcar synced sem confirmacao do servidor."
  },
  "domains": [
    {
      "id": "work_orders",
      ...
      "metrics": [
        {
          ...
          "type": "real",
          "status": "green",
          "detail": "576/576 esperado no sweep final — inclui 37 testes B-103 de OS sync e autosync de WorkOrder"
        },
        {
          "id": "npm_tests",
          "label": "Backend Tests",
...
const EMBEDDED_HISTORY = [
  ...
  },
  {
    ...
    "blocks_completed": 33,
    "description": "B-103 Flutter OS Sync Bidirecional — WorkOrder statusUpdate -> work_order.status_change, replay backend-ready, parser accepted/rejected/conflicts/already_applied e AutoSyncCoordinator"
  }
];
