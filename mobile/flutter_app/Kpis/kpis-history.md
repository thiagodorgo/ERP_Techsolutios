...
- +26 testes B-102 cobrindo serializer, parser, replay, provider e seguranca.

**Lacunas mantidas:** OS sync bidirecional, upload real de evidencias,
GPS/mapa, aprovacao real e piloto Android real.
