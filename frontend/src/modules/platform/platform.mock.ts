...
export const platformModuleCatalog: Array<Omit<PlatformModule, "status" | "availableInPlan">> = [
  ...
  { key: "technicians", name: "Tecnicos", description: "Cadastro e disponibilidade de equipes.", category: "Fase 2" },
  { key: "vehicles", name: "Veiculos", description: "Frota e ativos de campo.", category: "Fase 2" },
  { key: "reports", name: "Relatorios", description: "Relatorios gerenciais e operacionais.", category: "Fase 2" },
  { key: "audit", name: "Auditoria", description: "Trilha auditavel e eventos sensiveis.", category: "Fase 2" },
  { key: "integrations", name: "Integracoes", description: "Conectores externos e webhooks.", category: "Enterprise" },
  { key: "analytics", name: "Analytics", description: "Analises avancadas e indicadores preditivos.", category: "Enterprise" },
];
