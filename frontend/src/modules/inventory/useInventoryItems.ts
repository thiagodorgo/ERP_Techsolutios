...
import { listInventoryItemsFromApi } from "./inventory.service";
import type { InventoryItemsData, InventoryItemsFilters } from "./inventory.types";

export function useInventoryItems(filters: InventoryItemsFilters) {
