...
const permissionDescriptions = {
  ...
  "reports:read": "Consultar Relatórios e análises da organização.",
  "purchase_orders:read": "Consultar Pedidos de Compra da organização.",
  "purchase_orders:create": "Criar Pedidos de Compra da organização.",
  ...
  "yard:read": "Consultar Patios, areas e vagas (local de guarda fisico) do tenant.",
  "yard:create": "Criar Patios, areas e vagas do tenant.",
  "yard:update": "Editar Patios, areas e vagas (inclusive bloqueio operacional de vaga) do tenant.",
  "jurisdiction:read": "Consultar Perfis normativos (prazos legais, diaria, teto, exigencias de liberacao) do tenant.",
  "jurisdiction:create": "Criar Perfis normativos (convenio publico ou contrato privado) do tenant.",
  "jurisdiction:update": "Editar e inativar Perfis normativos do tenant.",
  "impound:read": "Consultar Processos de custodia, timeline de eventos e verificacao da cadeia de integridade do tenant.",
  ...
  "impound:notify": "Registrar emissao/dispensa de notificacoes legais do processo de custodia.",
  ...
  "financial_accounts:read": "Consultar Contas financeiras (caixa/banco/carteira) do tenant.",
  "financial_accounts:create": "Criar Contas financeiras do tenant.",
  "financial_accounts:update": "Editar e desativar (exclusao logica) Contas financeiras do tenant.",
  "financial_titles:read": "Consultar Titulos financeiros (a pagar/receber) do tenant.",
  "financial_titles:create": "Criar Titulos financeiros (a pagar/receber) do tenant.",
  "financial_titles:update": "Editar, mudar situacao e excluir (logica) Titulos financeiros do tenant.",
  "professional_statements:read": "Consultar o Extrato do profissional (razao financeiro por profissional) do tenant.",
  "professional_statements:create": "Lancar AJUSTE manual no Extrato do profissional do tenant.",
  "professional_statements:update": "Editar a descricao e retirar (exclusao logica) lancamentos do Extrato do profissional do tenant.",
  "financial_entries:read": "Consultar Caixa/Extrato e saldo das Contas financeiras do tenant.",
  "financial_entries:create": "Lancar caixa (entrada/saida) e liquidar Titulos financeiros do tenant.",
  "financial_entries:update": "Editar, estornar e excluir (logica) lancamentos de caixa do tenant.",
  "cheques:read": "Consultar Cheques (recebidos/emitidos) e seu ciclo de vida do tenant.",
  "cheques:create": "Registrar Cheques (recebidos/emitidos) do tenant.",
  "cheques:update": "Depositar, compensar (posta caixa), devolver e cancelar Cheques do tenant.",
  "financial_period:read": "Consultar o fechamento financeiro por competencia (status, snapshot e pendencias) do tenant.",
  "financial_period:close": "Fechar a competencia financeira (trava retroativa) do tenant.",
  "financial_period:reopen": "Reabrir competencia financeira fechada (exige justificativa) do tenant.",
