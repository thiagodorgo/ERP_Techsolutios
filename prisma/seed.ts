...
const permissionDescriptions = {
  ...
  "expense_report:read": "Consultar RDVs permitidos do tenant.",
  "expense_report:read_own": "Consultar apenas RDVs proprios.",
  "expense_report:create": "Criar RDV no modulo Gestao de Despesas.",
  "expense_report:update": "Atualizar RDV em status editavel.",
  "expense_report:submit": "Submeter RDV para aprovacao.",
  "expense_report:approve_manager": "Aprovar RDV operacionalmente como manager.",
  "expense_report:approve_finance": "Validar RDV financeiramente.",
  "expense_report:return": "Devolver RDV para correcao com motivo.",
  "expense_report:reject": "Rejeitar RDV com justificativa.",
  "expense_report:pay": "Agendar ou registrar pagamento/devolucao futura de RDV.",
