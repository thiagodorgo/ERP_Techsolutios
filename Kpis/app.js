const dashboardData = {
  project: {
    ...
    sourceBranch: "feature/mobile-native-gps-permissions",
    summary:
      "B-106 Adapter GPS nativo real + permissoes Android/iOS sincronizado com os KPIs mobile. Kpis/ reflete mobile/flutter_app/Kpis/ para Flutter 633/633, MVP demo 90%, MVP vendavel 68% e 36 blocos entregues.",
  },
  kpis: [
    { label: "B-106", value: "Adapter GPS nativo real", note: "Geolocator com permissao when-in-use, opt-in explicito e captura manual segura." },
    { label: "Flutter", value: "633/633", note: "Total real estimado para o full Flutter B-106 ate validacao final." },
    ...
    { label: "MVP demo", value: "90%", note: "Percentual mobile vindo de mobile/flutter_app/Kpis/kpis-latest.json." },
    { label: "MVP vendavel", value: "68%", note: "Percentual mobile vindo de mobile/flutter_app/Kpis/kpis-latest.json." },
    { label: "Blocos entregues", value: "36", note: "B-076 ate B-106 + B-098F, incluindo sub-blocos." },
    { label: "Escopo B-106", value: "mobile GPS", note: "Flutter/mobile, permissoes nativas, docs e KPIs; sem backend funcional, frontend web, Prisma, infra, env, lockfiles JS ou Figma." },
  ],
  blocks: [
  ...
  contracts: [
    {
      ...
      detail: "B-106 preserva evento manual e payload seguro; adapter nativo nao envia tenant/token/path/base64/file_data/local_path.",
    },
    {
      domain: "KPIs mobile",
      status: "concluido",
      endpoints: ["mobile/flutter_app/Kpis/kpis-latest.json", "mobile/flutter_app/Kpis/index.html"],
      detail: "Fonte dos percentuais Flutter/mobile: 633/633, 90%, 68%, 36 blocos.",
    },
    {
      domain: "KPIs raiz",
      status: "concluido",
  ...
  domains: [
    { name: "Flutter", status: "parcial", detail: "B-106 conecta adapter GPS nativo real com permissao when-in-use e opt-in explicito; piloto Android fisico ainda pendente." },
    { name: "Field Location", status: "parcial", detail: "Sync manual para Field Location e mapa operacional simples; geolocator conectado sem background tracking, stream, timer ou envio silencioso." },
  ...
  estimates: [
    ...
    { label: "MVP vendavel", value: "68%", detail: "Estimado no KPI mobile apos B-106." },
  ],
  risks: [
    { title: "Piloto Android real pendente", severity: "medio", detail: "B-106 conecta geolocator, mas ainda exige validacao em dispositivo fisico." },
    { title: "Sem coleta automatica", severity: "baixo", detail: "Sem background tracking, sem stream continuo, sem timer e sem envio silencioso." },
    { title: "Lacunas de campo avancadas", severity: "medio", detail: "Geofencing, roteirizacao e provider externo de mapa seguem pendentes se aprovados." },
  ],
  nextBlocks: [
    { id: "B-107", title: "Criacao remota de OS/local-only mapping", detail: "Proximo passo recomendado apos gate pos-B-106." },
  ],
  history: [
