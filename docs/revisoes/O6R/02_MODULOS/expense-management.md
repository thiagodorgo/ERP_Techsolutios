...
- Ω6R-DIN-009 — entrada completa, evidência, impacto, correção e teste em `../REGISTRO_ACHADOS_O6R.md`.
...
`src/modules/expense-management/**`; rotas/controllers/services/repositories encontrados, referências Prisma/migrations e testes pertinentes. A cobertura combina leitura profunda nos caminhos de risco com censo estrutural nas demais unidades.
