...
- Ω6R-PERF-002 — entrada completa, evidência, impacto, correção e teste em `../REGISTRO_ACHADOS_O6R.md`.
...
`frontend/src/**`; rotas/controllers/services/repositories encontrados, referências Prisma/migrations e testes pertinentes. A cobertura combina leitura profunda nos caminhos de risco com censo estrutural nas demais unidades.
