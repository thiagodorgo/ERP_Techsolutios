...
- `field_operations` e o modulo habilitavel por tenant para mapa operacional, operadores em campo e despachos. Nesta branch ele sustenta as rotas `/operations/map` e `/operations/dispatches` no frontend e o item `operations.dispatches` como `implemented`.
